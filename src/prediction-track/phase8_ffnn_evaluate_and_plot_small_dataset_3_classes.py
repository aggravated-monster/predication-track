...
def evaluate_control(classes, df):
    ...
    res, _ = p8.evaluate_group(df, features, 3, 'rmsprop', 0.001, "control", "control", classes, 1, get_output_figure_name)
    result.append(res)
...
def evaluate_highest_singles(classes, df):
    ...
    res, df_acc = p8.evaluate_group(df, features, 3, 'rmsprop', 0.001, "singles", "research", classes, 8, get_output_figure_name)
    result.append(res)
...
def evaluate_highest_pairs(classes, df):
    ...
    res, df_acc = p8.evaluate_group(df, features, 3, 'rmsprop', 0.001, "pairs", "research", classes, 193, get_output_figure_name)
    result.append(res)

    features = ['min_fixation_duration', 'perc_dwell_time_elsewhere']
    res, df_acc = p8.evaluate_group(df, features, 3, 'rmsprop', 0.001, "pairs", "research", classes, 193, get_output_figure_name, df_acc)
    result.append(res)
...
def evaluate_highest_triplet(classes, df):
    ...
    res, df_acc = p8.evaluate_group(df, features, 3, 'rmsprop', 0.001, "triplets", "research", classes, 217, get_output_figure_name, df_acc)
    result.append(res)
...
def evaluate_highest_quartets(classes, df):
    ...
    res, df_acc = p8.evaluate_group(df, features, 3, 'rmsprop', 0.001, "quartets", "research", classes, 217, get_output_figure_name)
    result.append(res)
...
def evaluate_highest_overall(classes, df):
    ...
    res, df_acc = p8.evaluate_group(df, features, 3, 'rmsprop', 0.001, "overall", "research", classes, 314, get_output_figure_name)
    result.append(res)
