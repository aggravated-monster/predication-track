...
def evaluate_highest_singles(classes, df):
    ...
    res, df_acc = p8.evaluate_group(df, features, 3, 'adam', 0.001, "singles", "research", classes, 8)
    result.append(res)

    # highest single from gaze features
    features = ['sum_delta_eye_euclid']
    res, df_acc = p8.evaluate_group(df, features, 3, 'rmsprop', 0.01, "singles", "gaze", classes, 8, df_acc)
    result.append(res)
    
    # highest single from instrument features
    features = ['sum_abs_delta_tooltip_y']
    res, df_acc = p8.evaluate_group(df, features, 3, 'sgd', 0.001, "singles", "instrument", classes, 8, df_acc)
    result.append(res)

    # highest single from spatial features
    features = ['sum_abs_x_distance']
    res, df_acc = p8.evaluate_group(df, features, 3, 'sgd', 0.001, "singles", "spatial", classes, 8, df_acc)
    result.append(res)
...
def evaluate_highest_pairs(classes, df):
    ...
    res, df_acc = p8.evaluate_group(df, features, 3, 'adam', 0.001, "pairs", "gaze", classes, 193, df_acc)
    result.append(res)
    ...
    res, df_acc = p8.evaluate_group(df, features, 3, 'rmsprop', 0.01, "pairs", "instrument", classes, 193, df_acc)
    result.append(res)
    ...
    res, df_acc = p8.evaluate_group(df, features, 2, 'rmsprop', 0.01, "pairs", "spatial", classes, 193, df_acc)
    result.append(res)
    ...
    res, df_acc = p8.evaluate_group(df, features, 1, 'rmsprop', 0.01, "pairs", "temporal", classes, 193, df_acc)
    result.append(res)
...
def evaluate_highest_triplet(classes, df):
    ...
    res, df_acc = p8.evaluate_group(df, features, 3, 'sgd', 0.01, "triplets", "gaze", classes, 217, df_acc)
    result.append(res)
    ...
    res, df_acc = p8.evaluate_group(df, features, 3, 'rmsprop', 0.001, "triplets", "instrument", classes, 217, df_acc)
    result.append(res)

    # highest triplet from spatial features
    features = ['sum_abs_x_distance', 'sum_abs_y_distance', 'sum_euclid_distance']
    res, df_acc = p8.evaluate_group(df, features, 2, 'rmsprop', 0.001, "triplets", "spatial", classes, 217, df_acc)
    result.append(res)

    # highest triplet from temporal features
    features = ['fixation_streak', 'departure_offset', 'arrival_offset']
    res, df_acc = p8.evaluate_group(df, features, 1, 'rmsprop', 0.01, "triplets", "temporal", classes, 217, df_acc)
    result.append(res)
...
def evaluate_highest_overall(classes, df):
    ...
    features = ['count_fixation_duration']
    res, df_acc = p8.evaluate_group(df, features, 3, 'adam', 0.01, "overall", "research", classes, 314)
    result.append(res)

    # highest overall from gaze features
    features = ['sum_delta_eye_euclid']
    res, df_acc = p8.evaluate_group(df, features, 3, 'rmsprop', 0.01, "overall", "gaze", classes, 314, df_acc)
    result.append(res)

    # highest overall from instrument features
    features = ['sum_abs_delta_tooltip_y']
    res, df_acc = p8.evaluate_group(df, features, 3, 'sgd', 0.001, "overall", "instrument", classes, 314, df_acc)
    result.append(res)

    # highest overall from spatial features
    features = ['sum_abs_x_distance']
    res, df_acc = p8.evaluate_group(df, features, 3, 'sgd', 0.001, "overall", "spatial", classes, 314, df_acc)
    result.append(res)

    # highest triplet from temporal features
    features = ['fixation_streak', 'departure_offset']
    res, df_acc = p8.evaluate_group(df, features, 1, 'rmsprop', 0.01, "overall", "temporal", classes, 314, df_acc)
    result.append(res)
