...
def get_output_base():
    ...
    return 'd:/ou/output/phase8/ffnn/modeling/large/2-classes/temporal/'

def get_evaluation_output_base():
    # change output base depending on which data set and number of classes
    return 'd:/ou/output/phase8/ffnn/evaluation/small/2-classes/temporal/'
...
if __name__ == "__main__":
    ...
    for i in range(nr_of_runs):
        ...
        for k in range(len(columns)):
            ...
            # do the work
            df_prediction_result, df_search_result = p8.perform_model_search(df_in, p8.create_model_grid, 'FFNN', params, feature_combinations, get_figures_output_base, CLASSES, k*10)
